...
namespace FluentEvents.Pipelines.Publication
{
    ...
    {
        /// <summary>
        ///     This method creates a <see cref="IPublishTransmissionConfiguration"/> with the specified sender type.
        /// </summary>
        ...
        IPublishTransmissionConfiguration With<T>() where T : IEventSender;
    }
}