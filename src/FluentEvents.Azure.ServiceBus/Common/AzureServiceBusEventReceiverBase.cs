...
{
    internal abstract class AzureServiceBusEventReceiverBase : IEventReceiver
    {
        private readonly ILogger _logger;
        private readonly IEventsSerializationService _eventsSerializationService;
        private readonly IPublishingService _publishingService;
        private readonly AzureServiceBusEventReceiverConfigBase _config;

        private IReceiverClient _subscriptionClient;

        protected AzureServiceBusEventReceiverBase(
            ILogger logger, 
