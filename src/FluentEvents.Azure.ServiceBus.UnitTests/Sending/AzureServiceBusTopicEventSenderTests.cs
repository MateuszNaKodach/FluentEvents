...
namespace FluentEvents.Azure.ServiceBus.UnitTests.Sending
{
    ...
    public class AzureServiceBusTopicEventSenderTests
    {
        ...
        private AzureServiceBusTopicEventSender _azureServiceBusTopicEventSender;
        ...
        public void SetUp()
        {
            ...
            _azureServiceBusTopicEventSender = new AzureServiceBusTopicEventSender(
                _loggerMock.Object,
                _eventsSerializationServiceMock.Object,
                Options.Create(new AzureServiceBusTopicEventSenderConfig
                {
