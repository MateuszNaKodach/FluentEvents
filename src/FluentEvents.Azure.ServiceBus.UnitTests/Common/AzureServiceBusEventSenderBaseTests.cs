...
namespace FluentEvents.Azure.ServiceBus.UnitTests.Common
{
    ...
    public class AzureServiceBusEventSenderBaseTests
    {
        ...
        public void SetUp()
        {
            ...
            _azureServiceBusEventSenderBase = new AzureServiceBusEventSenderImpl(
                _loggerMock.Object,
        ...
        public async Task SendAsync_ShouldSendMessage()
        {
            ...
            await _azureServiceBusEventSenderBase.SendAsync(_pipelineEvent);
        }
        ...
        public void Dispose_ShouldCloseTopicClient()
        {
            ...
            _azureServiceBusEventSenderBase.Dispose();
        }
        private class AzureServiceBusEventSenderImpl : AzureServiceBusEventSenderBase
        {
            public AzureServiceBusEventSenderImpl(
                ILogger logger,
