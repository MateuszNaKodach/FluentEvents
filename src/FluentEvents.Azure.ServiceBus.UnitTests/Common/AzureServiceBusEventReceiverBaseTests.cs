...
namespace FluentEvents.Azure.ServiceBus.UnitTests.Common
{
    ...
    public class AzureServiceBusEventReceiverBaseTests
    {
        ...
        private AzureServiceBusEventReceiverImpl _azureServiceBusEventReceiver;
        ...
        {
            _config = new AzureServiceBusEventReceiverConfigImpl
            {
            ...
            _azureServiceBusEventReceiver = new AzureServiceBusEventReceiverImpl(
                _loggerMock.Object,
            ...
            await _azureServiceBusEventReceiver.StartReceivingAsync(cts.Token);
        }
    ...
    internal class AzureServiceBusEventReceiverConfigImpl : AzureServiceBusEventReceiverConfigBase { }

    internal class AzureServiceBusEventReceiverImpl : AzureServiceBusEventReceiverBase
    {
        private readonly IReceiverClient _receiverClient;

        public AzureServiceBusEventReceiverImpl(
            ILogger logger,
            IEventsSerializationService eventsSerializationService,
            IPublishingService publishingService,
            AzureServiceBusEventReceiverConfigBase config,
