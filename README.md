...
- Publish events to global subscriptions transparently every instance of your application using [Azure Service Bus topics](https://azure.microsoft.com/en-us/services/service-bus/). 
